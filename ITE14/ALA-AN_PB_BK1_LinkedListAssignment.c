...
int main( )
{
    ...
    //3. remove the 8th node
                ...
                // If node8 is found, adjust the pointers to skip node8 from the list
                if (current != NULL) {
    ...
    //5. show the sum of all even numbers/values in the list
    ...
    //6. insert a new node with a value of 55 in between of node 44 and node 66
    ...
    //7. swap the 4th and 1st node. Swap the entire node not the value of the node.
               node4->next = node2;
                node3->next = node1;
                node1->next = new_node;
